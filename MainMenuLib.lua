-- PremiumUI_v7.lua
-- Full Premium UI Library with Fixed Color Picker, Debounced Notifications, Blur & Shadows
...
-- Window
function PremiumUI:CreateWindow(title)
    ...
    return setmetatable(self, PremiumUI)
end

function PremiumUI:AddButton(text, callback)
...
function PremiumUI:AddLabel(text)
...
-- Color Picker
function PremiumUI:AddColorPicker(defaultColor, callback)
        ...
        if i.UserInputType == Enum.UserInputType.MouseButton1 or i.UserInputType == Enum.UserInputType.Touch then
            ...
            conn = UserInputService.InputChanged:Connect(function(inp)
                if inp.UserInputType == Enum.UserInputType.MouseMovement or inp.UserInputType == Enum.UserInputType.Touch then
                    if isDragging then move(inp) end
                end
            end)
